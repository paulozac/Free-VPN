...
void awg_curve25519_derive_public_key(uint8_t public_key[32], const uint8_t private_key[32])
{
...
void awg_curve25519_generate_private_key(uint8_t private_key[32])
{
